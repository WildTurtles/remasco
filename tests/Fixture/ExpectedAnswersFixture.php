...
/**
 * ExpectedAnswersFixture
 *
 */
class ExpectedAnswersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'expected_answers_id' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            'id' => '32550311-1c09-4f82-b937-449af32eccb7',
