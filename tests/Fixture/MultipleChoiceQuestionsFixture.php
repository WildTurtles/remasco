...
/**
 * MultipleChoiceQuestionsFixture
 *
 */
class MultipleChoiceQuestionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'multiple_choice_questions_id' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            'id' => '1bac77cb-d01e-40f8-9451-ee44c443bc67',
