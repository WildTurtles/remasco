 ...
 * @property \App\Model\Table\QuestionsTriesTable|\Cake\ORM\Association\BelongsToMany $QuestionsTries
 *
...
class AnswersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsToMany('QuestionsTries', [
            'foreignKey' => 'answer_id',
            'targetForeignKey' => 'questions_try_id',
